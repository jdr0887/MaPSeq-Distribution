...
@Application(name = "GATKUnifiedGenotyper", executable = "$JAVA_HOME/bin/java -Xmx4g -Djava.io.tmpdir=$MAPSEQ_HOME/tmp -jar $%s_GATK2_HOME/GenomeAnalysisTK.jar --analysis_type UnifiedGenotyper")
