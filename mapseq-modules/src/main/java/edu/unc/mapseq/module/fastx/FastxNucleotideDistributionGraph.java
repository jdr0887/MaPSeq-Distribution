package edu.unc.mapseq.module.fastx;
...
@Application(name = "FastxNucleotideDistributionGraph")
@Executable(value = "$%s_FASTX_TOOLKIT_HOME/bin/fastx_nucleotide_distribution_graph.sh")
