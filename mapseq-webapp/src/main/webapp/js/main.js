...
app.config([ '$routeProvider', function($routeProvider) {
  ...
  .when("/reports/week", {
    templateUrl : "reports/week.html",
    controller : "weekWorkflowRunReportCtrl"
  })

  .when("/reports/month", {
    templateUrl : "reports/month.html",
    controller : "monthWorkflowRunReportCtrl"
  })
...
app
    .controller(
        ...
        function($scope, $resource) {
          ...
          $scope.weekWorkflowRunCountPieChartData = {
            series : [],
            data : []
          };
          $scope.weekWorkflowRunCountBarChartData = {
            series : [],
            data : []
          };

          $scope.weekWorkflowRunCountPieChartConfig = {
            click : function(d) {
          ...
          $scope.weekWorkflowRunCountBarChartConfig = {
            labels : false,
            tooltips : true,
            legend : {
              display : false,
          ...
          $scope.weekWorkflowRunDurationPieChartData = {
            series : [],
            data : []
          };
          $scope.weekWorkflowRunDurationBarChartData = {
            series : [],
            data : []
          };

          $scope.weekWorkflowRunDurationPieChartConfig = {
            labels : false,
            tooltips : true,
            legend : {
              display : false,
          ...
          $scope.weekWorkflowRunDurationBarChartConfig = {
            labels : false,
            tooltips : true,
            legend : {
              display : false,
          ...
          var workflowServiceResource = $resource('/cxf/Workflow/WorkflowService/findAll', null, {
            'query' : {
              method : 'GET',
              isArray : false
            }
          ...
          workflowServiceResourceQuery.$promise.then(function(workflowsData) {
            angular.forEach(workflowsData.workflow, function(workflowData) {

              var workflowRunAttemptResourceQuery = workflowRunAttemptResource.query({
                started : started,
                finished : finished,
              ...
              workflowRunAttemptResourceQuery.$promise.then(function(workflowRunAttemptsData) {
                ...
                var attempts = workflowRunAttemptsData.workflowRunAttempt;

                if (attempts.length > 0) {

                  $scope.weekWorkflowRunCountPieChartData.series.push(workflowData.name);
                  $scope.weekWorkflowRunCountPieChartData.data.push({
                    "x" : workflowData['@name'],
                    "y" : [ attempts.length ],
                    "tooltip" : workflowData['@name'] + ": " + attempts.length
                  });
                  ...
                  for (i = 0; i < 7; i++) {
                    ...
                    $scope.weekWorkflowRunCountBarChartData.data.push({
                      "x" : display,
                      "y" : [ 0 ]
                    });
                  }
                  ...
                  var duration = 0;
                  angular.forEach(attempts, function(workflowRunAttemptData) {
                  ...
                  $scope.weekWorkflowRunDurationPieChartData.data.push({
                    "x" : workflowData['@name'],
                    "y" : [ duration ],
                  ...
                  $scope.weekWorkflowRunDurationBarChartData.data.push({
                    "x" : workflowData['@name'],
                    "y" : [ Math.round(duration / (60 * 60 * 1000)) ]
                  });
          ...
          $scope.updateWeekWorkflowRunCountBarChart = function(d) {
            ...
            if (angular.isDefined(d) && angular.isDefined(d.data) && angular.isDefined(d.data.x)) {
              ...
              var workflowNameResource = $resource('/cxf/Workflow/WorkflowService/findByName/:name', {
                name : '@name'
              }, {
                'query' : {
                  method : 'GET',
              ...
              workflowNameResourceQuery.$promise
                  .then(function(workflowsData) {
                    angular
                        .forEach(
...
app
    .controller(
        ...
        function($scope, $resource) {
          ...
          $scope.monthWorkflowRunCountPieChartData = {
            series : [],
            data : []
          };
          $scope.monthWorkflowRunCountBarChartData = {
            series : [],
            data : []
          };

          $scope.monthWorkflowRunCountPieChartConfig = {
            click : function(d) {
          ...
          $scope.monthWorkflowRunCountBarChartConfig = {
            labels : false,
            tooltips : true,
            legend : {
              display : false,
          ...
          $scope.monthWorkflowRunDurationPieChartData = {
            series : [],
            data : []
          };
          $scope.monthWorkflowRunDurationBarChartData = {
            series : [],
            data : []
          };

          $scope.monthWorkflowRunDurationPieChartConfig = {
            labels : false,
            tooltips : true,
            legend : {
              display : false,
          ...
          $scope.monthWorkflowRunDurationBarChartConfig = {
            labels : false,
            tooltips : true,
            legend : {
              display : false,
            ...
            angular.forEach(workflowsData.workflow, function(workflowData) {
              ...
              workflowRunAttemptResourceQuery.$promise.then(function(workflowRunAttemptsData) {
                ...
                if (attempts.length > 0) {
                  ...
                  $scope.monthWorkflowRunCountPieChartData.data.push({
                    "x" : workflowData['@name'],
                    "y" : [ attempts.length ],
                    "tooltip" : workflowData['@name'] + ": " + attempts.length
                  });
                  ...
                  for (i = 0; i < 30; i++) {
                    ...
                    $scope.monthWorkflowRunCountBarChartData.data.push({
                      "x" : display,
                      "y" : [ 0 ]
                    });
                  }
                  ...
                  $scope.monthWorkflowRunDurationPieChartData.data.push({
                    "x" : workflowData['@name'],
                    "y" : [ duration ],
                    "tooltip" : workflowData['@name'] + ": " + Math.round(duration / (60 * 60 * 1000)) + " hours"
                  });
                  ...
                  $scope.monthWorkflowRunDurationBarChartData.data.push({
                    "x" : workflowData['@name'],
                    "y" : [ Math.round(duration / (60 * 60 * 1000)) ]
                  });
                }
