...
public class GenerateWeeklyWorkflowJobsPerClusterReportAction extends AbstractAction {

    private final Logger logger = LoggerFactory.getLogger(GenerateWeeklyWorkflowJobsPerClusterReportAction.class);
