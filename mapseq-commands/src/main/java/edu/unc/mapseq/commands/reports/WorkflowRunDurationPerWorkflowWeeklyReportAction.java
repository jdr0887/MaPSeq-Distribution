...
public class WorkflowRunDurationPerWorkflowWeeklyReportAction extends AbstractAction {

    private final Logger logger = LoggerFactory.getLogger(WorkflowRunDurationPerWorkflowWeeklyReportAction.class);
    ...
    protected Object doExecute() throws Exception {
        ...
        File chartFile = ReportFactory.createWorkflowRunDurationReport(workflowName, workflowRunAttemptList, startDate,
                endDate);
