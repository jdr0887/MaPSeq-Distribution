...
public class GenerateWeeklyJobsPerClusterReportAction extends AbstractAction {

    private final Logger logger = LoggerFactory.getLogger(GenerateWeeklyJobsPerClusterReportAction.class);
